...
<head>
  ...
  <style type="text/css">
    * {
    ...
    .csk {
      background-image: url("E:\IPL Project\IPL\src\main\webapp\Image\CSK.png");
    }


    .csk:hover {
      background-image: url("https://drive.google.com/file/d/1O8CMWr9-7pOq2WL9ULD-xGN4j3c3LZtk/view?usp=drive_link");
    }
